            ...
            <div className="container mx-auto px-4 max-w-5xl">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {steps.map(({ icon: Icon, title, description }, idx) => (
                        <div
                            key={title}
                            className="relative bg-white p-6 rounded-xl border border-gray-300 shadow-sm transition duration-300 hover:shadow-lg hover:scale-[1.03] cursor-pointer group"
                        >
